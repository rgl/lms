...
struct PFWUpdateDllWrapperME11::FUNCTIONS
{
...
PFWUpdateDllWrapperME11::PFWUpdateDllWrapperME11(void)
{
	...
	auto dllHandle = VerifyFile::SafeLoadDll(ME11_Dll_Name);
...
PFWUpdateDllWrapperME11::~PFWUpdateDllWrapperME11()
{
	delete functionsPtr;
}
...
uint32_t PFWUpdateDllWrapperME11::isFwInitDone(bool* isFwInitDone)
{
...
uint32_t PFWUpdateDllWrapperME11::isPfwuRequired(bool& isLoclPfuRequired, bool& isWcodPfurequired, uint32_t& requiredLanguage)
{
	unsigned int retcode = 8707;
