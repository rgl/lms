...
struct PFWUpdateDllWrapperME16::FUNCTIONS
{
...
PFWUpdateDllWrapperME16::PFWUpdateDllWrapperME16(void)
{
...
PFWUpdateDllWrapperME16::~PFWUpdateDllWrapperME16()
{
	delete functionsPtr;
}
...
uint32_t PFWUpdateDllWrapperME16::waitForFwInitDone() // this is a W/A for ME10 and ME11
{
	return SUCCESS;
}

uint32_t PFWUpdateDllWrapperME16::isPfwuRequired(bool& isLoclPfuRequired, bool& isWcodPfurequired, uint32_t& requiredLanguage)
{
...
uint32_t PFWUpdateDllWrapperME16::performPFWU(uint32_t partialID, const std::wstring& imagePath)
{
	uint32_t status = INTERNAL_ERROR;
