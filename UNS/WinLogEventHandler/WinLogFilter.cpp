...
static const std::vector<filter_entry> config_bindings = {
	...
	{ LMS_REG_TEXT("FWCIRAWORKAROUND_NOTACTIVE"), FWCIRAWORKAROUND_NOTACTIVE, UNS_GENERAL, EVENT_FWCIRAWORKAROUND_NOTACTIVE},

	{ LMS_REG_TEXT("PROVISIONING_STATE_PRE"), PROVISIONING_STATE_PRE, UNS_GENERAL, EVENT_PROVISIONING_STATE_PRE},
	{ LMS_REG_TEXT("PROVISIONING_STATE_IN"), PROVISIONING_STATE_IN, UNS_GENERAL, EVENT_PROVISIONING_STATE_IN},
	{ LMS_REG_TEXT("PROVISIONING_STATE_POST"), PROVISIONING_STATE_POST, UNS_GENERAL, EVENT_PROVISIONING_STATE_POST},

	{ LMS_REG_TEXT("USER_CONSENT_ENDED"), USER_CONSENT_ENDED, UNS_GENERAL, EVENT_USER_CONSENT_ENDED},
	{ LMS_REG_TEXT("USER_CONSENT_GRANTED"), USER_CONSENT_GRANTED, UNS_GENERAL, EVENT_USER_CONSENT_GRANTED},

	{ LMS_REG_TEXT("FIRMWARE_RESET"), FIRMWARE_RESET, UNS_GENERAL, EVENT_FIRMWARE_RESET},

	{ LMS_REG_TEXT("RCS_TUNNEL_CLOSE"), RCS_TUNNEL_CLOSE, UNS_GENERAL, EVENT_RCS_TUNNEL_CLOSE},
	{ LMS_REG_TEXT("RCS_TUNNEL_OPEN"), RCS_TUNNEL_OPEN, UNS_GENERAL, EVENT_RCS_TUNNEL_OPEN},

	{ LMS_REG_TEXT("WLAN_LINK_IS_DOWN"), WLAN_LINK_IS_DOWN, UNS_WLAN, EVENT_WLAN_LINK_IS_DOWN},
};
