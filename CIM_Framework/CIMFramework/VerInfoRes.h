...
#define MODULE_NAME         "CimFramework\0"
#define PRODUCT_BUILDVER    MCSDK_FILEVERSION_STR
#define INTERNAL_NAME       "CimFramework\0"
#define COPYRIGHT_STRING    "Copyright � 2004-2014 Intel Corporation, All rights reserved\0" 
#define ORIGINAL_NAME       "CimFramework.dll\0"
#define PRODUCT_NAME        "CimFramework Dynamic Link Library\0"
