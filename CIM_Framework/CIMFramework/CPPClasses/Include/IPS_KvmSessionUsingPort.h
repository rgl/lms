...
//
//  File:       IPS_KvmSessionUsingPort.h
//
...
//
//----------------------------------------------------------------------------
#ifndef IPS_KVMSESSIONUSINGPORT_H
#define IPS_KVMSESSIONUSINGPORT_H 1
...
namespace Typed 
{
	...
	class CIMFRAMEWORK_API IPS_KvmSessionUsingPort  : public IPS_SessionUsingPort
	{
	public:
		...
		IPS_KvmSessionUsingPort(ICimWsmanClient *client)
		...
		//Destructor
		virtual ~IPS_KvmSessionUsingPort(){}
		...
		// Class representing IPS_KvmSessionUsingPort keys
		...
		static vector<shared_ptr<IPS_KvmSessionUsingPort> > Enumerate(ICimWsmanClient *client, const CimKeys &keys = CimKeys()) ;
	...
	protected:
		...
		IPS_KvmSessionUsingPort(ICimWsmanClient *client, const string &class_name,
		...
		IPS_KvmSessionUsingPort(const CimObject &object)
...
#endif // IPS_KVMSESSIONUSINGPORT_H
