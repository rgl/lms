...
//
//----------------------------------------------------------------------------
#ifndef CIM_SYSTEMPACKAGING_H
#define CIM_SYSTEMPACKAGING_H 1
...
namespace Typed 
{
	...
	class CIMFRAMEWORK_API CIM_SystemPackaging  : public CIM_Dependency
	{
	public:
		...
		CIM_SystemPackaging(ICimWsmanClient *client)
		...
		// Class representing CIM_SystemPackaging keys
		class CimKeys : public CIM_Dependency::CimKeys
		{
		public:
			// Required, The PhysicalElements that provide the packaging of a System.
			...
			// Required, The System whose packaging is described.
		...
		static vector<shared_ptr<CIM_SystemPackaging> > Enumerate(ICimWsmanClient *client, const CimKeys &keys = CimKeys()) ;
	...
	protected:
		...
		CIM_SystemPackaging(ICimWsmanClient *client, const string &class_name,
		...
		CIM_SystemPackaging(const CimObject &object)
