...
//
//  File:       AMT_8021xCredentialContext.h
//
...
//
//----------------------------------------------------------------------------
#ifndef AMT_8021XCREDENTIALCONTEXT_H
#define AMT_8021XCREDENTIALCONTEXT_H 1
...
namespace Typed 
{
	...
	class CIMFRAMEWORK_API AMT_8021xCredentialContext  : public CIM_CredentialContext
	{
	public:
		...
		AMT_8021xCredentialContext(ICimWsmanClient *client)
		...
		//Destructor
		virtual ~AMT_8021xCredentialContext(){}
		...
		// Class representing AMT_8021xCredentialContext keys
		...
		public:
			...
			// Key, Required, The 8021XProfile that provides context or scope for the Credential.
		...
		static vector<shared_ptr<AMT_8021xCredentialContext> > Enumerate(ICimWsmanClient *client, const CimKeys &keys = CimKeys()) ;
	...
	protected:
		...
		AMT_8021xCredentialContext(ICimWsmanClient *client, const string &class_name,
		...
		AMT_8021xCredentialContext(const CimObject &object)
...
#endif // AMT_8021XCREDENTIALCONTEXT_H
