...
namespace Typed 
{
	...
	public:
		...
		//Input parameter for function PkiUnprovision
		class CIMFRAMEWORK_API PkiUnprovision_INPUT : public CimParam
		{
		public:
			// Class Constructor
			PkiUnprovision_INPUT() : CimParam() {}

			// Class Destructor
			~PkiUnprovision_INPUT(){}

			// Optional, A random nonce value generated by the configuration agent. Needs to be concatenated after the configuration nonce and signed together.
			void McNonce(const Base64 &value);
		...
		virtual unsigned int PkiUnprovision(const PkiUnprovision_INPUT &input);
