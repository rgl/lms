...
//
//  File:       CIM_AuthorizationService.h
//
...
//
//----------------------------------------------------------------------------
#ifndef CIM_AUTHORIZATIONSERVICE_H
#define CIM_AUTHORIZATIONSERVICE_H 1
...
namespace Typed 
{
	...
	class CIMFRAMEWORK_API CIM_AuthorizationService  : public CIM_SecurityService
	{
	public:
		...
		CIM_AuthorizationService(ICimWsmanClient *client)
		...
		//Destructor
		virtual ~CIM_AuthorizationService(){}
		...
		// Class representing CIM_AuthorizationService keys
		...
		static vector<shared_ptr<CIM_AuthorizationService> > Enumerate(ICimWsmanClient *client, const CimKeys &keys = CimKeys()) ;
	...
	protected:
		...
		CIM_AuthorizationService(ICimWsmanClient *client, const string &class_name,
		...
		CIM_AuthorizationService(const CimObject &object)
...
#endif // CIM_AUTHORIZATIONSERVICE_H
