...
//
//  File:       CIM_ServiceSAPDependency.h
//
...
//
//----------------------------------------------------------------------------
#ifndef CIM_SERVICESAPDEPENDENCY_H
#define CIM_SERVICESAPDEPENDENCY_H 1
...
namespace Typed 
{
	...
	class CIMFRAMEWORK_API CIM_ServiceSAPDependency  : public CIM_Dependency
	{
	public:
		...
		CIM_ServiceSAPDependency(ICimWsmanClient *client)
		...
		//Destructor
		virtual ~CIM_ServiceSAPDependency(){}
		...
		// Class representing CIM_ServiceSAPDependency keys
		class CimKeys : public CIM_Dependency::CimKeys
		{
		public:
			// Required, The required ServiceAccessPoint.
			...
			// Required, The Service that is dependent on an underlying SAP.
		...
		static vector<shared_ptr<CIM_ServiceSAPDependency> > Enumerate(ICimWsmanClient *client, const CimKeys &keys = CimKeys()) ;
	...
	protected:
		...
		CIM_ServiceSAPDependency(ICimWsmanClient *client, const string &class_name,
		...
		CIM_ServiceSAPDependency(const CimObject &object)
...
#endif // CIM_SERVICESAPDEPENDENCY_H
